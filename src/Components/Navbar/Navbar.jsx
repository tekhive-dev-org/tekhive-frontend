      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <h1 className="text-2xl font-bold text-[#0066FF]">TekHive</h1>
          </div>

          {/* Desktop Navigation */}
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              <a href="#home" className="text-[#525866] hover:text-[#0066FF] transition-colors duration-200">
                Home
              </a>
              <a href="#services" className="text-[#525866] hover:text-[#0066FF] transition-colors duration-200">
                About
              </a>
              <a href="#about" className="text-[#525866] hover:text-[#0066FF] transition-colors duration-200">
                Blog
              </a>
            </div>
          </div>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-300">
              ...
              <div className="px-3 py-2">
                <Button className="w-full border-1 border-[#0066FF] hover:bg-[#0066FF] text-[#525866]">Get Started</Button>
              </div>
            </div>
          </div>
        )}
